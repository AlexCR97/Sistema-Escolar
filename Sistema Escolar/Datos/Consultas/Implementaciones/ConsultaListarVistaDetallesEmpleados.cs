...
{
    public class ConsultaListarVistaDetallesEmpleados : Consulta
    {
        public ConsultaListarVistaDetallesEmpleados(params object[] args) : base(args) { }
        ...
        {
            return "select * from VistaDetallesEmpleado";
        }
    }
}
