...
{
    public class ConsultaListarVistaCoordinadores : Consulta
    {
        public ConsultaListarVistaCoordinadores(params object[] args) : base(args) { }
        ...
        {
            return "select * from Coordinadores";
        }
    }
}
